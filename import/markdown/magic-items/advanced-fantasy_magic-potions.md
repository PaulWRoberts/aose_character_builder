...
Grants the power of reading thoughts. This works in the same way as the magic-user spell *ESP* (see *Magic-User Spells* in the *Advanced Fantasy Player’s Tome*). The standard potion duration applies.
...
Drinking this potion, the character becomes invisible. This works the same as the magic-user spell *invisibility* (see *Magic-User Spells* in the *Advanced Fantasy Player’s Tome*). The standard potion duration applies.
...
Upon drinking this potion, the character transforms into another being (of their choice). This works in the same way as the magic-user spell *polymorph self* (see *Magic-User Spells* in the *Advanced Fantasy Player’s Tome*). The standard potion duration applies.
